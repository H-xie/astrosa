...
# folder
folder_name = os.path.join('experiments', 'different_configure')
...
# read Plan
asp_priority_plan = pd.read_sql('select * from priority_schedule_2023_06_08_00_00_00_dc', con=conn)
asp_sequantial_plan = pd.read_sql('select * from sequential_schedule_2023_06_08_00_00_00_dc', con=conn)
